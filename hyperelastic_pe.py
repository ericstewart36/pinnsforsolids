"""
Code for finite deformation hyperelasticity test problem:
    uniaxial extension
    
This code has all the machinery for inertial effects,
but they are disabled in  line 302.
...
# A basic box mesh 
mesh = RectangleMesh(Point(0,0),Point(1, 1),10,20)
...
dispTot  = 1.0       # total displacement, mm
#
...
# Output file setup
file_results = XDMFFile("results/2D_pe_FEniCS.xdmf")
